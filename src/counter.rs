...
impl Counter {
    ...
    /// Wakes all currently waiting fibers.
    /// This is used internally by decrement and can be used to manually flush
    /// stranded waiters (e.g., added after counter reached zero).
    pub fn notify_all<S: JobScheduler + ?Sized>(&self, scheduler: &S) {
