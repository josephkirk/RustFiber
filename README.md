...
- ✅ **Safe Parallel Iterators**: `fiber_iter` and `fiber_iter_mut` for parallel slice processing (Rayon-compatible).
    - *Comparable to Rayon (Tied in pure compute, ~40% faster in complex sync-heavy workloads)*.
