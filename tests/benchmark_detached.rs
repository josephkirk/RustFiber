...
fn benchmark_spawn_variations() {
    ...
    println!("Speedup Detached vs Base: {:.2}x", duration_base.as_secs_f64() / duration_detached.as_secs_f64());
    println!("Speedup Group vs Base: {:.2}x", duration_base.as_secs_f64() / duration_group.as_secs_f64());
}
